...
describe("DatabaseManager constructor", () => {
    it("should create database manager without error", (done) => {
        try {
    ...
    it("should create a valid connection to the database", () => {
        let dbm = new DatabaseManager();
    ...
    it('should create a collection of sequelize models', () => {
        let dbm = new DatabaseManager();
